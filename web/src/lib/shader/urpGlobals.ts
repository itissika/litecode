...
export const urpBuiltinVariables: URPVariable[] = [
  ...
  {
    name: "_MainLightOcclusionProbes",
    type: "half4",
    description: "主光源遮挡探针",
    category: "MainLight",
  },
  {
    name: "_MainLightLayerMask",
    type: "uint",
    description: "主光源渲染层掩码",
    category: "MainLight",
  },
  ...
  // 附加光源
  {
    ...
    type: "half4",
    description: "附加光源数量和参数",
    category: "AdditionalLights",
  },
  {
    name: "_AdditionalLightsPosition",
    type: "float4[]",
    description: "附加光源位置数组",
    category: "AdditionalLights",
  },
  {
    name: "_AdditionalLightsColor",
    type: "half4[]",
    description: "附加光源颜色数组",
    category: "AdditionalLights",
  },
  {
    name: "_AdditionalLightsAttenuation",
    type: "half4[]",
    description: "附加光源衰减数组",
    category: "AdditionalLights",
  },
  {
    name: "_AdditionalLightsSpotDir",
    type: "half4[]",
    description: "附加聚光灯方向数组",
    category: "AdditionalLights",
  },
  {
    name: "_AdditionalLightsOcclusionProbes",
    type: "half4[]",
    description: "附加光源遮挡探针数组",
    category: "AdditionalLights",
  },
  {
    name: "_AdditionalLightsLayerMasks",
    type: "float[]",
    description: "附加光源层掩码数组",
    category: "AdditionalLights",
  },

  // 阴影
  {
    name: "_MainLightWorldToShadow",
    type: "float4x4[5]",
    description: "主光源世界到阴影空间变换矩阵",
    category: "Shadow",
  },
  {
    name: "_CascadeShadowSplitSpheres0",
    type: "float4",
    description: "级联阴影分割球体0",
    category: "Shadow",
  },
  {
    name: "_CascadeShadowSplitSpheres1",
    type: "float4",
    description: "级联阴影分割球体1",
    category: "Shadow",
  },
  {
    name: "_CascadeShadowSplitSpheres2",
    type: "float4",
    description: "级联阴影分割球体2",
    category: "Shadow",
  },
  {
    name: "_CascadeShadowSplitSpheres3",
    type: "float4",
    description: "级联阴影分割球体3",
    category: "Shadow",
  },
  {
    name: "_MainLightShadowParams",
    type: "float4",
    description: "主光源阴影参数",
    category: "Shadow",
  },
  ...
  },
  {
    ...
    type: "TextureCube",
    description: "反射探针立方体贴图",
    category: "GI",
  },
  {
    name: "unity_SpecCube0_HDR",
    type: "half4",
    description: "反射探针HDR解码参数",
    category: "GI",
  },
...
export const urpBuiltinFunctions: URPFunction[] = [
  // 空间变换函数
  {
    ...
    parameters: [
      { name: "positionOS", type: "float3", description: "模型空间顶点位置" },
    ],
    returnType: "float4",
    category: "Transform",
  },
  ...
  },
  {
    ...
    parameters: [
      { name: "positionWS", type: "float3", description: "世界空间顶点位置" },
    ],
    returnType: "float4",
    category: "Transform",
  },
  ...
  },
  {
    ...
    parameters: [
      { name: "dirOS", type: "float3", description: "模型空间方向" },
    ],
    returnType: "float3",
    category: "Transform",
  },
  {
    ...
    parameters: [
      { name: "dirWS", type: "float3", description: "世界空间方向" },
    ],
    returnType: "float3",
    category: "Transform",
  },
  ...
  },
  {
    ...
    parameters: [
      { name: "shadowCoord", type: "float4", description: "阴影坐标" },
    ],
    returnType: "Light",
    category: "Lighting",
  },
...
export const urpBuiltinMacros: URPMacro[] = [
  ...
  {
    name: "_MAIN_LIGHT_SHADOWS_SCREEN",
    description: "启用屏幕空间阴影",
    category: "Keyword",
  },
  {
  ...
  {
    name: "_ADDITIONAL_LIGHTS_VERTEX",
    description: "启用顶点附加光照",
    category: "Keyword",
  },
  {
    name: "_ADDITIONAL_LIGHT_SHADOWS",
    description: "启用附加光源阴影",
    category: "Keyword",
  },
  { name: "_SHADOWS_SOFT", description: "启用软阴影", category: "Keyword" },
  {
    name: "_MIXED_LIGHTING_SUBTRACTIVE",
    description: "混合照明减法模式",
    category: "Keyword",
  },
  {
    name: "_SCREEN_SPACE_OCCLUSION",
    description: "启用屏幕空间遮挡",
    category: "Keyword",
  },
  { name: "_NORMALMAP", description: "启用法线贴图", category: "Keyword" },
  { name: "_EMISSION", description: "启用自发光", category: "Keyword" },
  {
    name: "_SPECULAR_SETUP",
    description: "使用高光工作流",
    category: "Keyword",
  },
  ...
  // 纹理宏
  {
    name: "TEXTURE2D",
    description: "声明2D纹理",
    usage: "TEXTURE2D(_MainTex)",
    category: "Texture",
  },
  {
    name: "TEXTURECUBE",
    description: "声明立方体纹理",
    usage: "TEXTURECUBE(_CubeMap)",
    category: "Texture",
  },
  {
    name: "TEXTURE3D",
    description: "声明3D纹理",
    usage: "TEXTURE3D(_Volume)",
    category: "Texture",
  },
  {
    name: "TEXTURE2D_ARRAY",
    description: "声明2D纹理数组",
    usage: "TEXTURE2D_ARRAY(_TexArray)",
    category: "Texture",
  },
  {
    name: "SAMPLER",
    description: "声明采样器",
    usage: "SAMPLER(sampler_MainTex)",
    category: "Texture",
  },
  {
    name: "SAMPLE_TEXTURE2D",
    description: "采样2D纹理",
    usage: "SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv)",
    category: "Texture",
  },
  {
    name: "SAMPLE_TEXTURE2D_LOD",
    description: "采样2D纹理指定LOD",
    usage: "SAMPLE_TEXTURE2D_LOD(_MainTex, sampler_MainTex, uv, lod)",
    category: "Texture",
  },
  {
    name: "SAMPLE_TEXTURECUBE",
    description: "采样立方体纹理",
    usage: "SAMPLE_TEXTURECUBE(_CubeMap, sampler_CubeMap, dir)",
    category: "Texture",
  },
  {
    name: "SAMPLE_TEXTURECUBE_LOD",
    description: "采样立方体纹理指定LOD",
    usage: "SAMPLE_TEXTURECUBE_LOD(_CubeMap, sampler_CubeMap, dir, lod)",
    category: "Texture",
  },
  ...
  // CBuffer 宏
  {
    name: "CBUFFER_START",
    description: "开始常量缓冲区",
    usage: "CBUFFER_START(UnityPerMaterial)",
    category: "CBuffer",
  },
  {
    name: "CBUFFER_END",
  ...
  // 实例化宏
  {
    ...
    description: "设置实例ID",
    usage: "UNITY_SETUP_INSTANCE_ID(input)",
    category: "Instancing",
  },
  {
    name: "UNITY_TRANSFER_INSTANCE_ID",
    description: "传递实例ID",
    usage: "UNITY_TRANSFER_INSTANCE_ID(input, output)",
    category: "Instancing",
  },
  {
    name: "UNITY_VERTEX_INPUT_INSTANCE_ID",
    description: "声明顶点输入实例ID",
    category: "Instancing",
  },
  ...
  // 立体渲染宏
  {
    ...
    usage: "UNITY_INITIALIZE_VERTEX_OUTPUT_STEREO(output)",
    category: "Stereo",
  },
  {
    name: "UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX",
    description: "设置立体眼睛索引",
    usage: "UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input)",
    category: "Stereo",
  },
];
