/**
 * Vendored HLSL keyword tables from
 * https://github.com/yyqrc/vscode-unitylabshader (MIT)
 * based on https://github.com/stef-levesque/vscode-shader (MIT)
 * and Microsoft HLSL documentation.
 */
...
export var intrinsicfunctions: IEntries = {
    ...
    parameters: [
      {
        label: "value",
        documentation:
          "The specified value. Each component should be a floating-point value within the range of -1 to 1. | 指定的值，每个分量应为-1到1范围内的浮点值。",
      },
    ],
  },
  all: {
    ...
    parameters: [
      {
        label: "lowbits",
        documentation:
          "The low 32-bit pattern of the input value. | 输入值的低32位。",
      },
      {
        label: "highbits",
        documentation:
          "The high 32-bit pattern of the input value. | 输入值的高32位。",
      },
    ],
  },
  asfloat: {
    ...
    parameters: [
      {
        label: "status",
        documentation:
          "The status value that is returned from a Sample, Gather, or Load operation. | 从 Sample、Gather 或 Load 操作返回的状态值。",
      },
    ],
  },
  clamp: {
    ...
    parameters: [
      ...
      {
        label: "min",
        documentation: "The specified minimum range. | 指定的最小范围",
      },
      {
        label: "max",
        documentation: "The specified maximum range. | 指定的最大范围",
      },
    ],
  },
  clip: {
    ...
    parameters: [
      {
        label: "value",
        documentation:
          "The specified value, in radians. | 指定的值，以弧度为单位",
      },
    ],
  },
  cosh: {
    ...
    parameters: [
      {
        label: "x",
        documentation:
          "The first floating-point, 3D vector. | 第一个浮点型三维向量",
      },
      {
        label: "y",
        documentation:
          "The second floating-point, 3D vector. | 第二个浮点型三维向量",
      },
    ],
  },
  D3DCOLORtoUBYTE4: {
    ...
    parameters: [
      {
        label: "value",
        documentation:
          "The floating-point vector4 to convert. | 要转换的浮点型四维向量",
      },
    ],
  },
  ddx: {
    ...
    parameters: [
      {
        label: "x",
        documentation:
          "The first floating-point vector to compare. | 第一个要比较的浮点型向量",
      },
      {
        label: "y",
        documentation:
          "The second floating-point vector to compare. | 第二个要比较的浮点型向量",
      },
    ],
  },
  dot: {
  ...
  errorf: {
    ...
    parameters: [
      ...
      {
        label: "argument ...",
        documentation: "Optional arguments. | 可选参数",
      },
    ],
  },
  ...
  EvaluateAttributeAtSample: {
    ...
    parameters: [
      ...
      {
        label: "sampleIndex",
        documentation: "The sample location. | 采样位置",
      },
    ],
  },
  EvaluateAttributeSnapped: {
    ...
    parameters: [
      { label: "value", documentation: "The input value. | 输入值" },
      {
        label: "offset",
        documentation:
          "A 2D offset from the pixel center using a 16x16 grid. | 使用16x16网格从像素中心的二维偏移",
      },
    ],
  },
  exp: {
    ...
    parameters: [
      {
        label: "n",
        documentation:
          "The resulting floating-point surface-normal vector. | 结果浮点型表面法线向量",
      },
      {
        label: "i",
        documentation:
          "A floating-point, incident vector that points from the view position to the shading position. | 从观察位置指向着色位置的浮点型入射向量",
      },
      {
        label: "ng",
        documentation:
          "A floating-point surface-normal vector. | 浮点型表面法线向量",
      },
    ],
  },
  firstbithigh: {
    ...
    parameters: [
      {
        label: "a",
        documentation:
          "The first value in the fused multiply-addition. | 融合乘加的第一个值",
      },
      {
        label: "b",
        documentation:
          "The second value in the fused multiply-addition. | 融合乘加的第二个值",
      },
      {
        label: "c",
        documentation:
          "The third value in the fused multiply-addition. | 融合乘加的第三个值",
      },
    ],
  },
  fmod: {
    ...
    parameters: [
      {
        label: "x",
        documentation: "The floating-point dividend. | 浮点被除数",
      },
  ...
  frexp: {
    ...
    parameters: [
      ...
      },
      {
        label: "exp",
        documentation:
          "The returned exponent of the x parameter. | 返回的 x 参数的指数",
      },
    ],
  },
  fwidth: {
  ...
  GetRenderTargetSamplePosition: {
    ...
    parameters: [
      {
        label: "index",
        documentation: "A zero-based sample index. | 以零为基础的采样索引",
      },
    ],
  },
  GroupMemoryBarrier: {
  ...
  InterlockedCompareExchange: {
    description:
      "Atomically compares the destination with the comparison value. If they are identical, the destination is overwritten with the input value.\n\n原子比较目标值与比较值，如果相同则用输入值覆盖目标值。",
    parameters: [
      { label: "dest", documentation: "The destination address. | 目标地址" },
      {
        label: "compareValue",
  ...
  lerp: {
    ...
    parameters: [
      ...
      },
      {
        label: "s",
        documentation:
          "A value that linearly interpolates between the x parameter and the y parameter. | 在 x 和 y 之间进行线性插值的值",
      },
    ],
  },
  lit: {
    ...
    parameters: [
      {
        label: "nDotL",
        documentation:
          "The dot product of the normalized surface normal and the light vector. | 归一化表面法线与光线向量的点积",
      },
      {
        label: "nDotH",
        documentation:
          "The dot product of the half-angle vector and the surface normal. | 半角向量与表面法线的点积",
      },
  ...
  mad: {
    ...
    parameters: [
      {
        label: "x",
        documentation: "The first multiplication value. | 第一个乘数",
      },
      {
        label: "y",
        documentation: "The second multiplication value. | 第二个乘数",
      },
  ...
  modf: {
    ...
    parameters: [
      ...
      {
        label: "ip",
        documentation: "The integer portion of x. | x 的整数部分",
      },
    ],
  },
  msad4: {
    ...
    parameters: [
      {
        label: "reference",
        documentation:
          "The reference array of 4 bytes in one uint value. | 一个 uint 值中的4字节参考数组",
      },
      {
        label: "source",
        documentation:
          "The source array of 8 bytes in two uint2 values. | 两个 uint2 值中的8字节源数组",
      },
      {
        label: "accum",
        documentation:
          "A vector of 4 values to accumulate. | 要累加的4个值的向量",
      },
    ],
  },
  mul: {
    ...
    parameters: [
      {
        label: "x",
        documentation:
          "The x input value. If x is a vector, it treated as a row vector. | x 输入值。如果 x 是向量，则视为行向量",
      },
      {
        label: "y",
        documentation:
          "The y input value. If y is a vector, it treated as a column vector. | y 输入值。如果 y 是向量，则视为列向量",
      },
    ],
  },
  noise: {
    ...
    parameters: [
      {
        label: "value",
        documentation:
          "A floating-point vector from which to generate Perlin noise. | 用于生成 Perlin 噪声的浮点向量",
      },
    ],
  },
  normalize: {
  ...
  Process2DQuadTessFactorsAvg: {
    description:
      "Generates the corrected tessellation factors for a quad patch (using average).\n\n生成四边形面片的校正细分因子（使用平均值）。",
    parameters: [
      {
        label: "RawEdgeFactors",
        documentation: "The edge tessellation factors. | 边缘细分因子",
      },
      {
        label: "InsideScale",
        documentation:
          "The scale factor (0.0 to 1.0). | 缩放因子（0.0 到 1.0）",
      },
      {
        label: "RoundedEdgeTessFactors",
        documentation: "The rounded edge factors. | 四舍五入的边缘因子",
      },
      {
        label: "RoundedInsideTessFactors",
        documentation: "The rounded inside factors. | 四舍五入的内部因子",
      },
      {
        label: "UnroundedInsideTessFactors",
        documentation: "The unrounded inside factors. | 未四舍五入的内部因子",
      },
    ],
  },
  Process2DQuadTessFactorsMax: {
    description:
      "Generates the corrected tessellation factors for a quad patch (using maximum).\n\n生成四边形面片的校正细分因子（使用最大值）。",
    parameters: [
      {
        label: "RawEdgeFactors",
        documentation: "The edge tessellation factors. | 边缘细分因子",
  ...
  Process2DQuadTessFactorsMin: {
    description:
      "Generates the corrected tessellation factors for a quad patch (using minimum).\n\n生成四边形面片的校正细分因子（使用最小值）。",
    parameters: [
      {
        label: "RawEdgeFactors",
        documentation: "The edge tessellation factors. | 边缘细分因子",
    ...
    parameters: [
      {
        ...
        documentation: "The desired detail factor. | 期望的细节因子",
      },
      {
        label: "RawDensityFactor",
        documentation: "The desired density factor. | 期望的密度因子",
      },
      {
        label: "RoundedDetailFactor",
        documentation: "The rounded detail factor. | 四舍五入的细节因子",
      },
      {
        label: "RoundedDensityFactor",
        documentation: "The rounded density factor. | 四舍五入的密度因子",
      },
    ],
  },
  ...
  ProcessTriTessFactorsAvg: {
    description:
      "Generates the corrected tessellation factors for a triangle patch (using average).\n\n生成三角形面片的校正细分因子（使用平均值）。",
    parameters: [
      {
        label: "RawEdgeFactors",
        documentation: "The edge tessellation factors. | 边缘细分因子",
  ...
  ProcessTriTessFactorsMax: {
    description:
      "Generates the corrected tessellation factors for a triangle patch (using maximum).\n\n生成三角形面片的校正细分因子（使用最大值）。",
    parameters: [
      {
        label: "RawEdgeFactors",
        documentation: "The edge tessellation factors. | 边缘细分因子",
  ...
  ProcessTriTessFactorsMin: {
    description:
      "Generates the corrected tessellation factors for a triangle patch (using minimum).\n\n生成三角形面片的校正细分因子（使用最小值）。",
    parameters: [
      {
        label: "RawEdgeFactors",
        documentation: "The edge tessellation factors. | 边缘细分因子",
    ...
    parameters: [
      {
        label: "i",
        documentation:
          "A floating-point, ray direction vector. | 浮点型光线方向向量",
      },
      {
        label: "n",
        documentation:
      ...
      },
      {
        label: "η",
        documentation:
          "A floating-point, refraction index scalar. | 浮点型折射率标量",
      },
    ],
  },
  reversebits: {
  ...
  sincos: {
    ...
    parameters: [
      ...
      {
        label: "c",
        documentation: "Returns the cosine of x. | 返回 x 的余弦值",
      },
    ],
  },
  sinh: {
    ...
    parameters: [
      {
        label: "min",
        documentation:
          "The minimum range of the x parameter. | x 参数的最小范围",
      },
      {
        label: "max",
        documentation:
          "The maximum range of the x parameter. | x 参数的最大范围",
      },
      {
        label: "x",
        documentation:
          "The specified value to be interpolated. | 要插值的指定值",
      },
    ],
  },
  sqrt: {
    ...
    parameters: [
      {
        label: "y",
        documentation:
          "The first floating-point value to compare. | 第一个要比较的浮点值",
      },
      {
        label: "x",
        documentation:
          "The second floating-point value to compare. | 第二个要比较的浮点值",
      },
    ],
  },
  tan: {
  ...
  tex1Dgrad: {
    ...
    parameters: [
      ...
      { label: "t", documentation: "The texture coordinate. | 纹理坐标" },
      {
        label: "ddx",
        documentation:
          "Rate of change of the surface geometry in the x direction. | 表面几何在 x 方向的变化率",
      },
      {
        label: "ddy",
        documentation:
          "Rate of change of the surface geometry in the y direction. | 表面几何在 y 方向的变化率",
      },
    ],
  },
  tex1Dlod: {
  ...
  transpose: {
    ...
    parameters: [
      { label: "value", documentation: "The specified matrix. | 指定的矩阵" },
    ],
  },
  trunc: {
    description:
    ...
    parameters: [
      { label: "value", documentation: "The specified input. | 指定的输入" },
    ],
  },
  ...
  WaveActiveAllEqual: {
    description:
      "Returns true if the expression is the same for every active lane in the current wave.\n\n如果当前波中所有活动通道的表达式相同，则返回 true。",
    parameters: [
      { label: "value", documentation: "The value to compare. | 要比较的值" },
    ],
  },
  WaveActiveBitAnd: {
    description:
    ...
    parameters: [
      { label: "value", documentation: "The value to AND. | 要进行与运算的值" },
    ],
  },
  WaveActiveBitOr: {
    description:
    ...
    parameters: [
      { label: "value", documentation: "The value to OR. | 要进行或运算的值" },
    ],
  },
  WaveActiveBitXor: {
    description:
    ...
    parameters: [
      {
        label: "value",
        documentation: "The value to XOR. | 要进行异或运算的值",
      },
    ],
  },
  WaveActiveCountBits: {
    ...
    parameters: [
      {
        label: "value",
        documentation: "The boolean value to count. | 要统计的布尔值",
      },
    ],
  },
  WaveActiveMax: {
    ...
    parameters: [
      {
        label: "value",
        documentation: "The value to find the max of. | 要查找最大值的值",
      },
    ],
  },
  WaveActiveMin: {
    ...
    parameters: [
      {
        label: "value",
        documentation: "The value to find the min of. | 要查找最小值的值",
      },
    ],
  },
  WaveActiveProduct: {
    description:
      "Returns the product of all the values of the expression across all active lanes in the current wave.\n\n返回当前波中所有活动通道表达式值的乘积。",
    parameters: [
      { label: "value", documentation: "The value to multiply. | 要相乘的值" },
    ],
  },
  WaveActiveSum: {
    description:
      "Returns the sum of all the values of the expression across all active lanes in the current wave.\n\n返回当前波中所有活动通道表达式值的总和。",
    parameters: [
      { label: "value", documentation: "The value to sum. | 要求和的值" },
    ],
  },
  WaveActiveAllTrue: {
    description:
    ...
    parameters: [
      {
        label: "value",
        documentation: "The boolean value to test. | 要测试的布尔值",
      },
    ],
  },
  WaveActiveAnyTrue: {
  ...
  WavePrefixCountBits: {
    description:
      "Returns the sum of all the specified boolean values in active lanes in the current wave with indices less than this lane.\n\n返回当前波中索引小于当前通道的所有活动通道中指定布尔值的总和。",
    parameters: [
      {
        label: "value",
        documentation: "The boolean value to count. | 要统计的布尔值",
  ...
  WaveReadLaneAt: {
    ...
    parameters: [
      ...
      {
        label: "laneIndex",
        documentation: "The lane index to read from. | 要读取的通道索引",
      },
    ],
  },
  WaveReadLaneFirst: {
  ...
  QuadReadLaneAt: {
    ...
    parameters: [
      { label: "value", documentation: "The source value. | 源值" },
      {
        label: "quadLaneID",
        documentation:
          "The lane ID within the quad (0-3). | 四边形内的通道 ID（0-3）",
      },
    ],
  },
  ...
  NonUniformResourceIndex: {
    description:
      "Marks a resource index as non-uniform, allowing divergent indexing into resource arrays.\n\n将资源索引标记为非均匀，允许对资源数组进行发散索引。",
    parameters: [
      { label: "index", documentation: "The resource index. | 资源索引" },
    ],
  },
  ...
  Sample: {
    ...
    parameters: [
      ...
      {
        label: "location",
        documentation: "The texture coordinates. | 纹理坐标",
      },
    ],
  },
  SampleBias: {
    description:
      "Samples a texture with a bias applied to the mipmap level.\n\n采样纹理，并对 mipmap 级别应用偏置。",
    parameters: [
      { label: "sampler", documentation: "The sampler state. | 采样器状态" },
      {
        label: "location",
  ...
  SampleCmp: {
    ...
    parameters: [
      {
        label: "sampler",
        documentation: "The sampler comparison state. | 采样器比较状态",
      },
      {
        label: "location",
        documentation: "The texture coordinates. | 纹理坐标",
      ...
      {
        label: "compareValue",
        documentation: "A value to compare. | 要比较的值",
      },
    ],
  },
  SampleCmpLevelZero: {
    description:
      "Samples a texture at mipmap level 0 and compares the result to a comparison value.\n\n在 mipmap 级别 0 采样纹理，并将结果与比较值进行比较。",
    parameters: [
      {
        label: "sampler",
        documentation: "The sampler comparison state. | 采样器比较状态",
  ...
  SampleGrad: {
    ...
    parameters: [
      ...
      },
      {
        label: "ddx",
        documentation:
          "The rate of change in the x direction. | x 方向的变化率",
      },
      {
        label: "ddy",
        documentation:
          "The rate of change in the y direction. | y 方向的变化率",
      },
    ],
  },
  SampleLevel: {
    ...
    parameters: [
      {
        label: "location",
        documentation:
          "The texture coordinates with mip level. | 带 mip 级别的纹理坐标",
      },
    ],
  },
  Gather: {
  ...
  GatherRed: {
    description:
      "Gets the red components of the four samples that would be used for bilinear interpolation.\n\n获取用于双线性插值的四个样本的红色分量。",
    parameters: [
      { label: "sampler", documentation: "The sampler state. | 采样器状态" },
      {
        label: "location",
  ...
  GatherGreen: {
    description:
      "Gets the green components of the four samples that would be used for bilinear interpolation.\n\n获取用于双线性插值的四个样本的绿色分量。",
    parameters: [
      { label: "sampler", documentation: "The sampler state. | 采样器状态" },
      {
        label: "location",
  ...
  GatherBlue: {
    description:
      "Gets the blue components of the four samples that would be used for bilinear interpolation.\n\n获取用于双线性插值的四个样本的蓝色分量。",
    parameters: [
      { label: "sampler", documentation: "The sampler state. | 采样器状态" },
      {
        label: "location",
  ...
  GatherAlpha: {
    description:
      "Gets the alpha components of the four samples that would be used for bilinear interpolation.\n\n获取用于双线性插值的四个样本的 Alpha 分量。",
    parameters: [
      { label: "sampler", documentation: "The sampler state. | 采样器状态" },
      {
        label: "location",
  ...
  GetDimensions: {
    ...
    parameters: [
      { label: "width", documentation: "The texture width. | 纹理宽度" },
      {
        label: "height",
        documentation:
          "The texture height (if applicable). | 纹理高度（如适用）",
      },
      {
        label: "numberOfLevels",
        documentation: "The number of mipmap levels. | mipmap 级别数",
      },
    ],
  },
};
...
export var semanticsNum: IEntries = {
  ...
  SV_DEPTHGREATEREQUAL: {
    description:
      "Valid in any shader, tests whether the value is greater than or equal to the depth data value.",
  },
  SV_DEPTHLESSEQUAL: {
    description:
      "Valid in any shader, tests whether the value is less than or equal to the depth data value.",
  },
  SV_TARGET: {
    description:
...
export var semantics: IEntries = {
  ...
  SV_GSINSTANCEID: {
    description:
      "Defines the instance of the geometry shader. Available as input to the geometry shader. The instance is needed as a geometry shader can be invoked up to 32 times on the same geometry primitive.",
  },
  SV_INNERCOVERAGE: {
    description:
      "Represents underestimated conservative rasterization information (i.e. whether a pixel is guaranteed-to-be-fully covered). Can be read or written by the pixel shader.",
  },
  SV_INSIDETESSFACTOR: {
    description:
  ...
  SV_PRIMITIVEID: {
    description:
      "Per-primitive identifier automatically generated by the runtime (see Using System-Generated Values (Direct3D 10)). Can be written to by the geometry or pixel shaders, and read by the geometry, pixel, hull or domain shaders.",
  },
  ...
  SV_VERTEXID: {
    description:
      "Per-vertex identifier automatically generated by the runtime (see Using System-Generated Values (Direct3D 10)). Available as the input to the vertex shader only.",
  },
  SV_VIEWPORTARRAYINDEX: {
    description:
      "Viewport array index. Applied to geometry shader output and indicates which viewport to use for the primitive currently being written out. Can be read or written by the pixel shader. The primitive will be transformed and clipped against the viewport specified by the index before it is passed to the rasterizer. This semantic applies only to primitives, if a primitive has more than one vertex the value from the leading vertex will be used.",
  },
};
...
export var datatypes: IEntries = {
  ...
  half: {
    description:
      "16-bit floating point value. This data type is provided only for language compatibility. Direct3D 10 shader targets map all half data types to float data types. A half data type cannot be used on a uniform global variable (use the /Gec flag if this functionality is desired).",
  },
  half1: {
  ...
  sampler: {
    description:
      "Use to declare sampler state as well as sampler-comparison state.",
  },
  SamplerState: {
    description:
      "Use to declare sampler state as well as sampler-comparison state.",
